...
/obj/item/rig_module/vision/multi_mining

	name = "hardsuit optical utility package"
	desc = "A complete visor system of optical scanners and vision modes for miners and engineers"
	icon_state = "fulloptics"
...
/obj/item/rig_module/vision/multi_emergency

	name = "hardsuit optical rescue package"
	desc = "A complete visor system of optical scanners and vision modes for specialists, like medical and security."
	icon_state = "fulloptics"
