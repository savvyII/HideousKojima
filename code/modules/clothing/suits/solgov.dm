...
/obj/item/clothing/suit/storage/service/sifguard
	name = "\improper Epsilon Eridani Guard jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has silver buttons."
	icon_state = "blackservice_crew"

/obj/item/clothing/suit/storage/service/sifguard/medical
	name = "\improper SifGuard medical jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has silver buttons and blue trim."
	icon_state = "blackservice_med"

/obj/item/clothing/suit/storage/service/sifguard/medical/command
	name = "\improper Epsilon Eridani Guard medical command jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has gold buttons and blue trim."
	icon_state = "blackservice_medcom"

/obj/item/clothing/suit/storage/service/sifguard/engineering
	name = "\improper Epsilon Eridani Guard engineering jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has silver buttons and orange trim."
	icon_state = "blackservice_eng"

/obj/item/clothing/suit/storage/service/sifguard/engineering/command
	name = "\improper Epsilon Eridani Guard engineering command jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has gold buttons and orange trim."
	icon_state = "blackservice_engcom"

/obj/item/clothing/suit/storage/service/sifguard/supply
	name = "\improper Epsilon Eridani Guard supply jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has silver buttons and brown trim."
	icon_state = "blackservice_sup"

/obj/item/clothing/suit/storage/service/sifguard/security
	name = "\improper Epsilon Eridani Guard security jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has silver buttons and red trim."
	icon_state = "blackservice_sec"

/obj/item/clothing/suit/storage/service/sifguard/security/command
	name = "\improper Epsilon Eridani Guard security command jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has gold buttons and red trim."
	icon_state = "blackservice_seccom"

/obj/item/clothing/suit/storage/service/sifguard/command
	name = "\improper Epsilon Eridani Guard command jacket"
	desc = "A uniform service jacket belonging to the Epsilon Eridani Defense Force. It has gold buttons and gold trim."
	icon_state = "blackservice_com"

/obj/item/clothing/suit/storage/service/marine
	name = "marine coat"
	desc = "An SSA Marine Corps service coat. Green and undecorated."
...
/obj/item/clothing/suit/storage/service/marine/medical
	...
	desc = "An SSA Marine Corps service coat. This one has blue markings."
...
/obj/item/clothing/suit/storage/service/marine/medical/command
	...
	desc = "An SSA Marine Corps service coat. This one has blue and gold markings."
	icon_state = "greenservice_medcom"

/obj/item/clothing/suit/storage/service/marine/engineering
	name = "marine engineering jacket"
	desc = "An SSA Marine Corps service coat. This one has orange markings."
...
/obj/item/clothing/suit/storage/service/marine/security/command
	...
	desc = "An SSA Marine Corps service coat. This one has red and gold markings."
	icon_state = "greenservice_seccom"

/obj/item/clothing/suit/storage/service/marine/command
	name = "marine command jacket"
	desc = "An SSA Marine Corps service coat. This one has gold markings."
...
/obj/item/clothing/suit/dress/expedition
	name = "Epsilon Eridani Guard dress jacket"
	desc = "A silver and grey dress jacket belonging to the Epsilon Eridani Defense Force. Fashionable, for the 25th century at least."
	icon_state = "greydress"

/obj/item/clothing/suit/dress/expedition/command
	name = "Epsilon Eridani Guard command dress jacket"
	desc = "A gold and grey dress jacket belonging to the Epsilon Eridani Defense Force. The height of fashion."
...
/obj/item/clothing/suit/storage/toggle/dress/fleet
	...
	desc = "A crisp white SSA Fleet dress jacket with blue and gold accents. Don't get near pasta sauce or vox."

/obj/item/clothing/suit/storage/toggle/dress/fleet/command
	name = "fleet command dress jacket"
	desc = "A crisp white SSA Fleet dress jacket dripping with gold accents. So bright it's blinding."
...
/obj/item/clothing/suit/dress/marine
	...
	desc = "A tailored black SSA Marine Corps dress jacket with red trim. So sexy it hurts."
	icon_state = "blackdress"
	item_state_slots = list(slot_r_hand_str = "suit_black", slot_l_hand_str = "suit_black")

/obj/item/clothing/suit/dress/marine/command
	name = "marine command dress jacket"
	desc = "A tailored black SSA Marine Corps dress jacket with gold trim. Smells like ceremony."
