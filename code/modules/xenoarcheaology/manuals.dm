...
/obj/item/weapon/book/manual/anomaly_spectroscopy
	...
	dat = {"<html>
				...
				same! Why, look at the strides we're making in piercing the walls of Wormholes or our steadily improving ability to clarify and stabilise subspace emissions; it's
...
/obj/item/weapon/book/manual/anomaly_testing
	...
	dat = {"<html>
				...
				<br>
				By employing a patented semi-phased alloy with unique and fascinating wormhole interaction properties, Ward's contraption is able to 'harvest' energy, store
...
/obj/item/weapon/book/manual/stasis
	...
	dat = {"<html>
				...
				It was in examining the effects of decelerated, wormholes, high energy particles when transphased through wormholes that the effects where primarily noticed.
				Due to exigent properties of that dimension, transphasing those particles capable of existing in wormholes with high stability levels has the effect of bringing
