...
/material/proc/generate_recipes()
	...
	recipes += new/datum/stack_recipe("[display_name] armor plate", /obj/item/clothing/accessory/armor/armorplate/material, 1, time = 20, on_floor = 1, supplied_material = "[name]")
