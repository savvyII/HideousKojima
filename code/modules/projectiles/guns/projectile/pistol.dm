...
/obj/item/weapon/gun/projectile/p92x
	name = "Type 92x"
	desc = "The Type 92X is a product of Kusanagi Precision Machinery and is renowned for it's price point and reliability. \
	Commonly seen in use by military and police forces across the galaxy. Chambered in 9mm."
	icon_state = "p92x"
	origin_tech = list(TECH_COMBAT = 3, TECH_MATERIAL = 2)
	caliber = "9mm"
	load_method = MAGAZINE
