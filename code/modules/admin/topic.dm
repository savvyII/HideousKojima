...
//Regular jobs
	...
	//JOBBAN'S INNARDS
		...
		if(alert(src.owner, "Are you sure you wish to hit [key_name(M)] with Heavy Artillery?",  "Confirm Firing?" , "Yes" , "No") != "Yes")
			return
		...
		M << "You've been hit by heavy artillery!"
		log_admin("[key_name(M)] has been hit by Heavy Artillery fired by [src.owner]")
		message_admins("[key_name(M)] has been hit by Heavy Artillery fired by [src.owner]")
