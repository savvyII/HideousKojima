...
/obj/random/maintenance/security/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(3);/obj/item/clothing/suit/armor/pcarrier,
				prob(2);/obj/item/clothing/suit/armor/pcarrier/security,
				prob(2);/obj/item/clothing/suit/armor/pcarrier/police,
				prob(1);/obj/item/clothing/suit/armor/pcarrier/security/detective,
				prob(1);/obj/item/clothing/suit/armor/pcarrier/blue,
