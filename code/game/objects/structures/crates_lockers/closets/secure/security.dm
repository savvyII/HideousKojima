...
/obj/structure/closet/secure_closet/hop
	...
	New()
		...
		new /obj/item/weapon/storage/box/ids( src )
		new /obj/item/weapon/gun/energy/gun(src)
		new /obj/item/weapon/gun/projectile/mk58/flash(src)
		new /obj/item/device/flash(src)
		return
...
/obj/structure/closet/secure_closet/hos
	...
	New()
		...
		new /obj/item/clothing/suit/armor/pcarrier/security/hos(src)
		...
		new /obj/item/clothing/head/helmet/security/dermal(src)
...
/obj/structure/closet/secure_closet/warden
	...
	New()
		...
		if(prob(50))
			new /obj/item/weapon/storage/backpack/dufflebag/sec(src)
		new /obj/item/clothing/suit/armor/pcarrier/security/warden(src)
		...
		new /obj/item/clothing/head/helmet/security/dermal(src)
		new /obj/item/clothing/head/helmet/security/warden(src)
